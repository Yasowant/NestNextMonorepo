  ...
  return (
    <div className="bg-gradient-to-br from-sky-500 to-indigo-500 text-white pt-12">
      <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
        <div className="flex flex-col w-full justify-center items-center items-start md:w-2/5 text-center md:text-left">
          <p className="capitalize tracking-wide w-full">
            Dive into insights, tutorials, and narratives crafted for
            inquisitive minds like yours.
          </p>
          <h2 className="my-5 text-5xl font-bold leading-tight">
            WelCome to Mid Night Code Blog
          </h2>
          <p className="capitalize leading-normal text-xl">
            Be part of a community that flourishes through learning, innovation,
            and shared growth.
          </p>
        </div>
